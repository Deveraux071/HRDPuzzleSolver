...
if __name__ == '__main__':
  ...
  os.system("python3 hrd.py hrd_input2.txt hrd_dfs.txt hrd_output2.txt")
  ...
  if output_lines[0].startswith("Cost of the solution"):
    ...
    print("First line mismatch. Expected: Cost of the solution, Encountered: " +
          output_lines[0])
  ...
  # # Invoke the shell command to test the HRD solver
  # print("Input file: hrd_input1.txt, output file: hrd_output1.txt")
  # os.system("python3 hrd.py hrd_input1.txt hrd_dfs.txt hrd_output1.txt")
  #
  # output_read = open("hrd_output1.txt", "r")
  # solution_read = open("hrd_solution1.txt", "r")
  #
  # output_lines = output_read.readlines()
  # solution_lines = solution_read.readlines()
  # passed = True
